  ...
  return (
    <div className="container mx-auto space-y-8 p-8">
      ...
      <div className="space-y-2">
        ...
        <ComingSoon className="h-40 rounded-lg bg-gray-100">
          <div className="p-4">
      ...
      <div className="space-y-2">
        <h2 className="text-xl font-semibold">
          Detailed Variant with Different Icons
        </h2>
        <div className="grid grid-cols-2 gap-4">
          <ComingSoon
            ...
            icon="sparkles"
            className="h-48 rounded-lg bg-gradient-to-br from-purple-50 to-pink-50"
          />
          ...
          <ComingSoon
            ...
            icon="snowflake"
            className="h-48 rounded-lg bg-gradient-to-br from-blue-50 to-cyan-50"
          />
          ...
          <ComingSoon
            ...
            icon="clock"
            className="h-48 rounded-lg bg-gradient-to-br from-yellow-50 to-orange-50"
          />
          ...
          <ComingSoon
            ...
            icon="construction"
            className="h-48 rounded-lg bg-gradient-to-br from-green-50 to-emerald-50"
          />
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        >
          <Card className="p-6">
            <h3 className="mb-2 text-lg font-semibold">Advanced Settings</h3>
            <div className="space-y-2">
