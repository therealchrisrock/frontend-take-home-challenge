...
describe('LocalStorageAdapter', () => {
  ...
  describe('loadGame', () => {
    ...
    it('should return null if no game exists', async () => {
      ...
      expect(mockStorage.getItem).toHaveBeenCalledWith('checkers_game_nonexistent');
    });
  ...
  describe('deleteGame', () => {
    it('should remove game from localStorage', async () => {
      ...
      expect(result.success).toBe(true);
      expect(mockStorage.removeItem).toHaveBeenCalledWith('checkers_game_test-id');
    });
    ...
    it('should return true even if no game exists', async () => {
      ...
      expect(result.success).toBe(true);
      expect(mockStorage.removeItem).toHaveBeenCalledWith('checkers_game_nonexistent');
    });
  });
  ...
  describe('clearAll', () => {
    it('should clear all games', async () => {
      ...
      Object.keys = vi.fn().mockReturnValue(['checkers_game_test-id', 'checkers_games_list']);
  ...
  describe('migration and versioning', () => {
    it('should handle games with different versions', async () => {
      ...
      mockStorage.setItem('checkers_game_test-id', JSON.stringify(oldVersionGame));
