...
import type { GameAnalysis, MoveCategory } from '~/lib/types/move-analysis';
        ...
        <div className="space-y-4">
          ...
          {showGraph && (
            <div className="bg-gray-800 rounded-lg p-3">
              <svg viewBox="0 0 400 120" className="w-full h-24">
                ...
                <rect x="0" y="0" width="400" height="120" fill="url(#evalGradient)"/>
                
                {/* Zero line */}
                <line x1="0" y1="60" x2="400" y2="60" stroke="gray" strokeWidth="1" opacity="0.3"/>
                ...
                <polyline
                  ...
                  points={analysis.evaluationGraph
                    .map((point, idx) => {
                      const x = (idx / Math.max(1, analysis.evaluationGraph.length - 1)) * 400;
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between bg-gray-800 rounded-lg px-4 py-3">
              <div className="text-2xl font-bold">{redStats.accuracy.toFixed(1)}</div>
              <div className="text-2xl font-bold">{blackStats.accuracy.toFixed(1)}</div>
            </div>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 pt-2">
          <div className="text-center">
            ...
            <p className="text-lg font-bold">{analysis.criticalMoments.length}</p>
          </div>
          <div className="text-center">
