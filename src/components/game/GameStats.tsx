...
export function GameStats({ board, currentPlayer, moveCount, winner, gameStartTime }: GameStatsProps) {
    ...
    <Card className="w-full ">
        ...
        <CardTitle className="flex items-center justify-between">
          ...
          {winner && (
            <Badge variant="default" className="bg-green-600">
              ...
              {winner === 'draw' ? 'Draw!' : `${winner === 'red' ? 'Red' : 'Black'} Wins!`}
            </Badge>
          )}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-amber-800">Current Turn</span>
          <Badge 
            variant="outline" 
            className={currentPlayer === 'red' ? 'border-red-600 text-red-600' : 'border-gray-800 text-gray-800'}
          >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-amber-800">Red Pieces</span>
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-amber-800">Black Pieces</span>
            <div className="flex gap-2">
              <Badge variant="outline" className="border-gray-800 text-gray-800">
                {pieces.black} Regular
              </Badge>
              {pieces.blackKings > 0 && (
                <Badge variant="outline" className="border-gray-800 text-gray-800 bg-gray-100">
