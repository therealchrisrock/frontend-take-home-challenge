      ...
      <AlertDialog open={showResignDialog} onOpenChange={setShowResignDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to resign? This will end the game and declare{' '}
              {gameMode === 'local' 
                ? `${currentPlayer === 'red' ? 'Black' : 'Red'}` 
                : 'your opponent'} as the winner.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      {gameMode === 'local' && (
        <AlertDialog open={showDrawDialog} onOpenChange={() => onDeclineDraw()}>
          <AlertDialogContent>
            ...
            {drawRequestedBy !== currentPlayer && (
              <AlertDialogFooter>
                <AlertDialogCancel onClick={onDeclineDraw}>Decline</AlertDialogCancel>
                <AlertDialogAction onClick={onAcceptDraw}>Accept Draw</AlertDialogAction>
              </AlertDialogFooter>
            )}
          </AlertDialogContent>
        </AlertDialog>
